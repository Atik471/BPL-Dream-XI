...
function Newsletter(){
    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center text-black bg-white absolute top-0 translate-y-[-50%] rounded-2xl w-[60%] p-[4rem] font-sora gap-3 border-2 border-slate-300"
